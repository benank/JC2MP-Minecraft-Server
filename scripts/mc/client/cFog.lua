...
function Fog2:__init(args)
    ...
    self.num_layers = args.num_layers and args.num_layers or 75

    -- Distance of first layer from camera. 
    self.first_layer_dist = args.first_layer_dist and args.first_layer_dist or 15

    -- Distance between layers. Closer = smoother transition
    self.dist_between_layers = args.dist_between_layers and args.dist_between_layers or 0.25

    -- Color of the layers. Keep in mind the alpha.
    self.color = args.color and args.color or Color(0,0,0,20)

    self.fade_out_time = args.fade_out_time and args.fade_out_time or 10
    self.fading_out = false

    self.fade_in_time = args.fade_in_time and args.fade_in_time or 10
    self.fading_in = false

    self.fade_delta = 0

    self.range = self.first_layer_dist * 5 -- Size of rectangles
