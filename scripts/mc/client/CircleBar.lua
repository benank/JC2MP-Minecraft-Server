...
function CircleBar:__init(pos, size, data, inner_radius, outline_enabled) -- Make a circle bar with as many sections as you like
	...
	self.inner_radius = inner_radius or 0
	self.background_color = Color(0,0,0,120)
	self.outline_enabled = outline_enabled or false
